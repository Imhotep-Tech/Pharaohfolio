      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="relative w-full max-w-md">
          ...
          <div className="pharaoh-card rounded-3xl p-8 shadow-2xl border border-white/10 backdrop-blur-2xl bg-obsidian-900/60">
            ...
            {info && (
              <div className="mb-6 p-4 bg-blue-950/40 border border-blue-900/50 rounded-xl">
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-blue-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                  </svg>
                  <span className="text-blue-300 font-medium text-sm">{info}</span>
                </div>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <Link 
                  to="/forgot-password" 
                  className="text-xs text-gold-400 hover:text-gold-300 font-medium transition-colors hover:underline"
                >
            ...
            <button
              ...
              className="w-full py-3 px-6 bg-white/5 hover:bg-white/10 text-white border border-white/10 font-semibold rounded-xl transition-all duration-300 flex items-center justify-center hover:border-gold-500/30"
            >
